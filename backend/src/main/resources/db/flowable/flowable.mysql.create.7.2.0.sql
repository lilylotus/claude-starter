-- ----------------------------------------------------------------------------
-- Flowable 7.2.0 ProcessEngine MySQL 空库初始化脚本
--
-- 目标版本：Flowable 7.2.0（schema.version = 7.2.0.2）
-- 兼容数据库：MySQL 5.7 / MySQL 8.0
-- 适用范围：仅限不含任何 Flowable ACT_* / FLW_* 对象的空 schema，一次性执行。
--
-- 执行顺序：common -> engine -> history。
-- 来源：
...
--
-- 不支持重复执行，也不得用于已有 Flowable schema 的升级；脚本不会创建/删除数据库、
-- 删除表或清空数据。执行完成后，设置 flowable.database-schema-update=false 再启动应用。
-- ----------------------------------------------------------------------------
-- ============================================================================
-- Official Flowable 7.2.0 source: org/flowable/common/db/create/flowable.mysql.create.common.sql
-- ============================================================================
-- Flowable 引擎全局属性与 schema 版本记录。
...
-- ============================================================================
-- Official Flowable 7.2.0 source: org/flowable/db/create/flowable.mysql.create.engine.sql
-- ============================================================================
-- 流程定义、模型等资源的部署批次。
...
-- ============================================================================
-- Official Flowable 7.2.0 source: org/flowable/db/create/flowable.mysql.create.history.sql
-- ============================================================================
-- 已启动流程实例的历史主记录。
