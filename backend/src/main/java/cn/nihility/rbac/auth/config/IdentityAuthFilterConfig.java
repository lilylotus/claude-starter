 ...
 * 全部请求路径生效，顺序设置为高优先级以尽早拦截未登录/首登待改密请求。
 */
@Configuration
public class IdentityAuthFilterConfig {
    ...
    public FilterRegistrationBean<IdentityAuthFilter> identityAuthFilter(TokenService tokenService,
        ...
        FilterRegistrationBean<IdentityAuthFilter> registration =
                new FilterRegistrationBean<>(new IdentityAuthFilter(tokenService, passwordService));
