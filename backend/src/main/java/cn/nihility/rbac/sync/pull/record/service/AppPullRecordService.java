 ...
 * 的分页拉取方法调用）、按应用 id 分页查询拉取日志（add-app-sync-notify-pull-logs
 * change design.md Decision 2/3；{@code pullMode} 随拉取接口合并为一个而删除，见
...
public interface AppPullRecordService {
     ...
     */
    void record(Long appRefId, String dataType, String requestSummary, int resultCount);
