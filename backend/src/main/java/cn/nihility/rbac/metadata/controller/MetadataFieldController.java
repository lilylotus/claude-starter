...
public class MetadataFieldController {
    ...
    public List<MetadataFieldVO> available(
        ...
        return metadataFieldService.listAvailable(bizType);
    }
    ...
    /**
     * 更新元数据字段，仅字段名称可通过本接口修改。
     *
     * @param id      元数据字段 id
     * @param request 更新请求
     * @return 更新后的元数据字段详情
     */
    @Operation(summary = "更新元数据字段", description = "仅字段名称可通过本接口修改，表名称/字段列名/字段类型/业务对象类型创建后不可变")
